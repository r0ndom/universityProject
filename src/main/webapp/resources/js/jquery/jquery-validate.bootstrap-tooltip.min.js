...
(function (e) {
    e.extend(true, e.validator, {prototype: {defaultShowErrors: function () {
        ...
        var r = {animation: e(t).data("animation") || true, html: e(t).data("html") || false, placement: e(t).data("placement") || "top", selector: e(t).data("animation") || true, title: e(t).attr("title") || n, trigger: e.trim("manual " + (e(t).data("trigger") || "")), delay: e(t).data("delay") || 0, container: e(t).data("container") || false};
